 ...
 */public class FileInfoQuery extends BaseQuery{
    ...
    private String[] excluderFileIdArray;

    public String[] getExcluderFileIdArray() {
        return excluderFileIdArray;
    }

    public void setExcluderFileIdArray(String[] excluderFileIdArray) {
        this.excluderFileIdArray = excluderFileIdArray;
    }
	...
	public void setFlieCategory(Integer fileCategory) {
